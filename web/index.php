        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="/index.php" class="navbar-brand">
                    <img src="https://www.youthforseva.org/wp-content/themes/yfs_2016/images/youth-for-seva.png" alt="Youth For Seva" title="Youth For Seva">
                </a>
            </div>
            <form class="navbar-form navbar-right" action="/action_page.php">
                ...
                <button type="submit" class="btn btn-primary navbar-btn navbar-right">Submit</button>
            </form>
        </div>
    </nav>
