...
public class PendingAdapter extends BaseAdapter{
    ...
    public PendingAdapter(Context context, ArrayList<EventDetails> words) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        final View listitem = View.inflate(context, R.layout.pending_events, null);
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(email).child("pending").
