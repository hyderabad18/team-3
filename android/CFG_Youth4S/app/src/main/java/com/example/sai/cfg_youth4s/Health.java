...
public class Health extends Fragment {
    private String Database_Path = "Events/Health/";
    ...
    private String category=Health.this.getClass().getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference commandsRef = databaseReference.child("Events").child("Health");
...
//                    editor.commit();
                    adapter = new HealthyAdapter(getActivity(),list);
