...
public class OngoingAdapter extends BaseAdapter{
    ...
    public OngoingAdapter(Context context, ArrayList<EventDetails> words) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        final View listitem = View.inflate(context, R.layout.ongoing_events, null);
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(email).child("completed").
